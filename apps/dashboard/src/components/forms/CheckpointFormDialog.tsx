    ...
    <div className="grid gap-5 px-6 py-5">
      ...
      <form onSubmit={submit} className="grid gap-4">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <Controller name="scanType" control={control} render={({ field }) => <Select label="Verification method" hideLabel={false} value={field.value} onValueChange={(value) => field.onChange(value ?? "qr")}><Select.Option value="qr">QR code</Select.Option><Select.Option value="nfc">NFC tag</Select.Option></Select>} />
          <Controller name="evidence" control={control} render={({ field }) => <Select label="Required evidence" hideLabel={false} value={field.value} onValueChange={(value) => field.onChange(value ?? "none")}><Select.Option value="none">None</Select.Option><Select.Option value="photo">Photo</Select.Option><Select.Option value="note">Officer note</Select.Option></Select>} />
        </div>
